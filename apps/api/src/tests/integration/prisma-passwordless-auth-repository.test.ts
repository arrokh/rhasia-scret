...
import { PrismaPasswordlessAuthRepository } from "@api/modules/identity/infrastructure/prisma-passwordless-auth-repository";
...
describe("PrismaPasswordlessAuthRepository", () => {
  it.skipIf(!process.env.DATABASE_URL)(
    ...
    async () => {
      const repository = new PrismaPasswordlessAuthRepository(prisma, configuration);
