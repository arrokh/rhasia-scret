...
import { PrismaVaultParticipantRepository } from "@api/modules/vault-membership/infrastructure/prisma-vault-participant-repository";
...
describe("PrismaVaultParticipantRepository", () => {
  it.skipIf(!process.env.DATABASE_URL)(
    ...
    async () => {
      ...
      const repository = new PrismaVaultParticipantRepository(prisma, () => new Date("2026-07-29T12:00:00.000Z"));
      ...
      const memberships = new PrismaMembershipLifecycleRepository(prisma);
