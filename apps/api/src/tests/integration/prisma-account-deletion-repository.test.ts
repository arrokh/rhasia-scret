...
import { PrismaAccountDeletionRepository } from "@api/modules/account-deletion/infrastructure/prisma-account-deletion-repository";
...
describe("PrismaAccountDeletionRepository", () => {
  it.skipIf(!process.env.DATABASE_URL)(
    ...
    async () => {
      ...
      const repository = new PrismaAccountDeletionRepository(bytes("deletion-secret"), prisma);
