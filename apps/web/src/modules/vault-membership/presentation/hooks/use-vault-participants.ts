...
export const vaultParticipantsKey = (vaultId: string) =>
  ["vault-membership", "shared-vault", vaultId, "participants"] as const;
export const vaultDefaultAccountPermissionsKey = (vaultId: string) =>
  ["vault-membership", "shared-vault", vaultId, "account-permission-defaults"] as const;
