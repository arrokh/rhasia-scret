...
export function VaultManagementPreview() {
  ...
  const vault = {
    ...
    accounts: [
      { id: "opaque-account-1", issuer: sample("sampleService"), accountName: "viewer@local.invalid", revision: 1 },
    ],
  };
  return (
    <div className="grid gap-5">
      <SurfaceCard aria-label={t("listLabel")}>
        <SharedVaultDirectory vaults={[vault]} />
      </SurfaceCard>
      <SurfaceCard aria-label={t("detailLabel")}>
        <SharedVaultDetails
          vault={vault}
          ownerEmail="owner@local.invalid"
