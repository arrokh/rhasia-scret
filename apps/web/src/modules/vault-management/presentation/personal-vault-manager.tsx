    ...
    <div className="p-5 sm:p-6">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="details" className="grid gap-6">
          <dl className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div className="grid content-start gap-1">
              <dt className="text-xs font-bold tracking-wider text-muted-foreground uppercase">{t("owner")}</dt>
              <dd className="break-all text-sm font-bold text-foreground">{ownerEmail}</dd>
            </div>
            <div className="grid content-start gap-1">
              <dt className="text-xs font-bold tracking-wider text-muted-foreground uppercase">{t("vaultName")}</dt>
              <dd className="text-sm font-bold text-foreground">{vault.name}</dd>
            </div>
          </dl>
        ...
        <TabsContent value="audit">
          <VaultAuditHistory audit={audit} accounts={vault.accounts} />
        </TabsContent>
      </Tabs>
    </div>
  );
