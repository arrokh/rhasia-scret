...
export interface LocalVaultCryptoPort {
  ...
  createEncryptedVaultExport(vaultKey: Uint8Array, archiveKey: Uint8Array, encryptedName: Uint8Array, encryptedAccounts: Uint8Array[], context: Pick<CryptoEnvelopeContext, "vaultId" | "profileId">, accountIds: string[]): Promise<Uint8Array>;
...
export interface LocalVaultAccountPayloadPort {
  ...
  isDuplicateAccount(candidate: TotpConfiguration, accounts: Array<DecryptedAuthenticatorAccount & { id?: string }>): boolean;
