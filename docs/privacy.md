...
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Self-managed passwordless authentication or an OIDC Authentication Provider | Email or provider subject, authentication events, session material, and provider metadata required to verify a principal                    | The self-managed service or configured OIDC provider verifies authentication. No external provider receives Vault plaintext from this application. Configure applicable retention, access control, and privacy notices. |
...
| PostgreSQL provider                                                         | Encrypted content, opaque identifiers, permitted metadata, and database connection/operational logs                                         | The database must remain behind server-side Prisma. Do not enable browser database/API access for this application. The operator owns backups, restore, purge scheduling, and database access.                          |
