...
| ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Autentikasi passwordless yang dikelola sendiri             | Email terverifikasi, peristiwa autentikasi, dan materi sesi untuk memverifikasi principal                              | Layanan yang dikelola sendiri memverifikasi autentikasi. Tidak ada provider autentikasi eksternal yang menerima plaintext Vault dari aplikasi ini. Atur retensi pengiriman email, kontrol akses, dan pemberitahuan privasi yang berlaku. |
