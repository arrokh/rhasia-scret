...
const mocks = vi.hoisted(() => ({ updateVaultDefaults: vi.fn(), updateMemberOverrides: vi.fn() }));
...
import { PATCH as updateDefaults } from "@/app/api/shared-vaults/[vaultId]/member-permissions/route";
