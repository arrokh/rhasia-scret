...
vi.mock("@/modules/identity/infrastructure/prisma-passkey-recovery-repository", () => ({ PrismaPasskeyRecoveryRepository: class { removeCredential = mocks.removeCredential; } }));
