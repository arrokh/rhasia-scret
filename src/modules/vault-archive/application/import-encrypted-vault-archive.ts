...
export function importEncryptedVaultArchive(actorUserId: string, request: EncryptedVaultImport, repository: EncryptedVaultImportRepository): Promise<EncryptedVaultImportResult> {
