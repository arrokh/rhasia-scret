...
export function VaultManagementPreview() {
  ...
  const vault = { id: "shared-preview", name: sample("operations"), role: "OWNER" as const, key: new Uint8Array(32), accounts: [{ id: "opaque-account-1", issuer: sample("sampleService"), accountName: "viewer@local.invalid", revision: 1 }] };
