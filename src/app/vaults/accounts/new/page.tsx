  ...
  return (
    <main className="vault-page">
      <header className="vault-header">
        <div><p className="eyebrow">AKUN BARU</p><h1>Tambahkan akun autentikator</h1><p className="vault-subtitle">Pilih Brankas Pribadi atau Brankas Bersama yang Anda miliki.</p></div>
      </header>
      <section className="vault-card" aria-label="Formulir akun autentikator baru">
        <AuthenticatorAccountCreator personalVaultId={personalVault.id} />
      </section>
    </main>
  );
}
